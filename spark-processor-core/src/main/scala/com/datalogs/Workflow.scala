...
import com.datalogs.inputformats._
...
trait Workflow {
  implicit class DmzSparkContext(sc: SparkContext) {
  ...
  implicit class DmzOutputRDD[R <: SpecificRecord : ClassTag](val rdd: RDD[(LocalDate, R)]) {
